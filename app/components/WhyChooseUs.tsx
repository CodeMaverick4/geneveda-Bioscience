                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <ScrollReveal>
                        <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
                            Why Partner With <span className="text-[#7c1d85]">GeneVeda?</span>
                        </h2>
                    ...
                    <ScrollReveal delay={0.2} className="relative w-full">
                        <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-gray-100 aspect-[4/3] group cursor-pointer">
                            <div className="absolute inset-0 bg-gradient-to-br from-[#7c1d85] to-[#2c0a30] transition-colors duration-500">
                                {/* Abstract Pattern */}
                                ...
                                <div className="absolute inset-0 flex items-center justify-center p-12">
                                    <div className="grid grid-cols-2 gap-6 w-full h-full max-w-sm opacity-30 rotate-12 group-hover:rotate-0 transition-transform duration-700">
                                        ...
                                        <div className="bg-[#ffeb0f] rounded-2xl w-full h-full backdrop-blur-md" />
                        ...
                        {/* Decorative Elements */}
                        <div className="absolute -bottom-12 -right-12 w-48 h-48 bg-[#ffeb0f] rounded-full opacity-30 blur-3xl" />
                        <div className="absolute -top-12 -left-12 w-48 h-48 bg-[#7c1d85] rounded-full opacity-30 blur-3xl" />
                    </ScrollReveal>
                </div>
            </div>
        </section>
